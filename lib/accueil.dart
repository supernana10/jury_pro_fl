      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          GridView.count(
            ...
            children: <Widget>[
              _buildCard(
                  'Evenement', 'Available', "images/icon_event.jpg", Home(), 1),
              _buildCard('Candidats', 'Away', "images/icon_candidat.jpg",
                  Candidats(), 2),
              _buildCard('Jury', 'Away', "images/icon_jury.jpg", Home(), 3),
              _buildCard(
                  'Groupes', 'Available', "images/icon_groupe.jpg", Home(), 4),
            ],
          )
        ],
      ),
